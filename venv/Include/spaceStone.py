    ...
    def __init__(self, screen):
        ...
        for i in range(1, 5):
            self.flyImages.append(
                pygame.transform.scale(pygame.image.load("images/spacestone(" + str(i) + ").png"),
        ...
        for i in range(1, 7):
            self.explosionImages.append(
                pygame.transform.scale(pygame.image.load("images/exposed/exposed(" + str(i) + ").png"),
