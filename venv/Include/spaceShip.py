...
class spaceShip():
    def __init__(self, screen):
        ...
        self.flyImages = [pygame.transform.scale(pygame.image.load("images/spaceship.png"),
                                                 (self.rectangle[2], self.rectangle[3])),
                          pygame.transform.scale(pygame.image.load("images/spaceship1.png"),
                                                 (self.rectangle[2], self.rectangle[3]))]

        self.exposedImage = pygame.transform.scale(pygame.image.load("images/spaceship2.png"),
                                                   (self.rectangle[2], self.rectangle[3]))
